...
export default class Register extends Component {
  ...
  render() {
    return (
      <MDBContainer
        fluid
        className="container page-bg overflow-hidden bg-overlay"
      >
        {/* <Particles /> */}
        ...
        <MDBRow className="pt-5 mt-5">
          <MDBCol col="10" md="6">
            <img src={registerimg} class="img-fluid" alt="signup" />
          </MDBCol>

          <MDBCol col="4" md="6" className="ps-5">
            <MDBCard
              className="mx-auto px-3 bg-black text-white"
              style={{
                borderRadius: "1rem",
                width: "500px",
                minHeight: "600px",
